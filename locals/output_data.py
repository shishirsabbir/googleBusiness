...
def exportData(filename ,data_list):
    ...
    with open(f'./data_final/json/{filename}.json', mode='w', encoding='utf-8') as json_output_file:
        json_data = json.dumps(data_list)
        json_output_file.write(json_data)
        print('--Data Saved as JSON file!')

    with open(f'./data_final/csv/{filename}.csv', mode='w', encoding='utf-8', newline='') as csv_output_file:
